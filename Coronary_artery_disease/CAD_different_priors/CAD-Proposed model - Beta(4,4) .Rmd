...
```{r}
# Save the results
save(BETA, ZLV,THETA,GLOBAL_THETA,theta_j, file = "CAD-Proposed model_Beta(4,4).RData")

# To load the results back in future sessions
load("CAD-Proposed model_Beta(4,4).RData")
...
# Run diagnostics
plot_trace_density_to_pdf(BETA_thinned, pretty_labels, "TraceDensity_Beta_PostThinning_flexible_Beta(4,4).pdf")
plot_trace_density_to_pdf(BETA_ZLV_thinned, pretty_labels, "TraceDensity_BetaZ_PostThinning_flexible_Beta(4,4).pdf")
plot_acf_to_pdf(BETA_thinned, pretty_labels, "ACF_Beta_PostThinning_flexible_Beta(4,4).pdf")
plot_acf_to_pdf(BETA_ZLV_thinned, pretty_labels, "ACF_BetaZ_PostThinning_flexible_Beta(4,4).pdf")
...
pdf("TraceDensity_GlobalTheta_PostThinning_flexible_Beta(4,4).pdf", width = 8, height = 4)
par(mfrow = c(1, 2), mar = c(4, 4, 3, 1))
...
# ACF plot
pdf("ACF_GlobalTheta_PostThinning_flexible_Beta(4,4).pdf", width = 6, height = 4)
...
write.csv(csv_out, "OR_PSP_AllPredictors_flexible_Beta(4,4).csv", row.names = FALSE)
...
writeLines(latex_code_paper, con = "OR_PSP_Table_NoIntercept_PAPER_flexible_Beta(4,4).tex")
...
writeLines(latex_code_present, con = "OR_PSP_Table_NoIntercept_PRESENT_flexible_Beta(4,4).tex")
