...
```{r}
# Global theta initial value
GLOBAL_THETA[1]

# Local theta_j initial values (first row of THETA)
THETA[1, ]

# Initial inclusion vector (first row of ZLV)
ZLV[1, ]
...
```{r}
# Save the results
save(BETA, ZLV,THETA,GLOBAL_THETA,theta_j, file = "CAD-Proposed model_Beta(1,1)_0.9.RData")

# To load the results back in future sessions
load("CAD-Proposed model_Beta(1,1)_0.9.RData")
...
# Save as PDF table
pdf("ESS_Summary_PostThinning_flexible_Beta(1,1)_0.9.pdf", width = 8, height = 5)
...
# Run diagnostics
plot_trace_density_to_pdf(BETA_thinned, pretty_labels, "TraceDensity_Beta_PostThinning_flexible_Beta(1,1)_0.9.pdf")
plot_trace_density_to_pdf(BETA_ZLV_thinned, pretty_labels, "TraceDensity_BetaZ_PostThinning_flexible_Beta(1,1)_0.9.pdf")
plot_acf_to_pdf(BETA_thinned, pretty_labels, "ACF_Beta_PostThinning_flexible_Beta(1,1)_0.9.pdf")
plot_acf_to_pdf(BETA_ZLV_thinned, pretty_labels, "ACF_BetaZ_PostThinning_flexible_Beta(1,1)_0.9.pdf")
...
pdf("TraceDensity_GlobalTheta_PostThinning_flexible_Beta(1,1)_0.9.pdf", width = 8, height = 4)
par(mfrow = c(1, 2), mar = c(4, 4, 3, 1))
...
# ACF plot
pdf("ACF_GlobalTheta_PostThinning_flexible_Beta(1,1)_0.9.pdf", width = 6, height = 4)
...
```{r}
png("trace_global_theta_CAD_Beta(1,1)_0.9.png", width = 800, height = 600)
...
```
```{r}
png("density_global_theta_CAD_Beta(1,1)_0.9.png", width = 800, height = 600)
...
acf(GLOBAL_THETA)
png("acf_global_theta_CAD_Beta(1,1)_0.9.png", width = 800, height = 600)
...
pdf("CI_PSP_Paper_flexible_CAD_Beta(1,1)_0.9.pdf", width = 12, height = 7)
...
pdf("CI_PSP_Presentation_flexible_CAD_Beta(1,1)_0.9.pdf", width = 12, height = 7)
...
writeLines(latex_code_paper, con = "OR_PSP_Table_NoIntercept_PAPER_flexible_Beta(1,1)_0.9.tex")
...
writeLines(latex_code_present, con = "OR_PSP_Table_NoIntercept_PRESENT_flexible_Beta(1,1)_0.9.tex")
...
write.csv(csv_out, "OR_PSP_AllPredictors_flexible_CAD_Beta(1,1)_0.9.csv", row.names = FALSE)
...
pdf("performance_metrics_comparison_Beta(1,1)_0.9.pdf", width = 8, height = 11)
