...
zlv <- rbinom(k, line=1, prob=theta_j)
...
pdf("CI_PSP_Paper_flexible_CAD_.pdf", width = 12, height = 7)
...
pdf("CI_PSP_Presentation_flexible_CAD_.pdf", width = 12, height = 7)
...
write.csv(csv_out, "OR_PSP_AllPredictors_flexible_CAD.csv", row.names = FALSE)
