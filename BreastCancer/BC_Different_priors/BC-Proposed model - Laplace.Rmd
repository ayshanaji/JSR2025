...
```{r}
# Save the results
save(BETA, ZLV,THETA,GLOBAL_THETA,theta_j, file = "BC-Proposed model_laplace.RData")

# To load the results back in future sessions
load("BC-Proposed model_laplace.RData")
...
# Run diagnostics
plot_trace_density_to_pdf(BETA_thinned, variable_names, "TraceDensity_Beta_PostThinning_flexible_laplace.pdf")
plot_trace_density_to_pdf(BETA_ZLV_thinned, variable_names, "TraceDensity_BetaZ_PostThinning_flexible_laplace.pdf")
plot_acf_to_pdf(BETA_thinned, variable_names, "ACF_Beta_PostThinning_flexible_laplace.pdf")
plot_acf_to_pdf(BETA_ZLV_thinned, variable_names, "ACF_BetaZ_PostThinning_flexible_laplace.pdf")
...
```{r}
png("trace_global_theta_BC_laplace.png", width = 800, height = 600)
...
```
```{r}
png("density_global_theta_BC_laplace.png", width = 800, height = 600)
...
acf(GLOBAL_THETA)
png("acf_global_theta_BC_laplace.png", width = 800, height = 600)
...
pdf("CI_PSP_Paper_flexible_BC_laplace.pdf", width = 12, height = 7)
...
pdf("CI_PSP_Presentation_flexible_BC_laplace.pdf", width = 12, height = 7)
...
write.csv(csv_out, "OR_PSP_AllPredictors_flexible_BC_laplace.csv", row.names = FALSE)
